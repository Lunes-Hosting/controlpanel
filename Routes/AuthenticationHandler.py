...
import products
sys.path.append("..")
from legacy_scripts import after_request_async, convert_to_product, generate_reset_token, generate_verification_token, send_email, send_reset_email, send_verification_email
from managers.pterodactyl_manager import Pterodactyl
